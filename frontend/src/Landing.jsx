      ...
      <div className="page">
        ...
        <footer className="landing-footer">
          ...
          <div className="lf-right">
            ...
            <a href="https://x.com/curioswhispers" target="_blank" rel="noopener noreferrer" style={{ color: "#818cf8", fontWeight: 700, fontSize: 12, textDecoration: "none", marginLeft: 10 }}>@curioswhispers</a>
          </div>
        </footer>
      </div>
