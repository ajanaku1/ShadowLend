...
export const GradientBackground: React.FC<{ variant?: 'default' | 'warm' | 'cool' }> = ({
  ...
  const colors =
    variant === 'warm'
      ? { orb1: 'rgba(251,191,36,0.08)', orb2: 'rgba(129,140,248,0.06)' }
      : variant === 'cool'
        ? { orb1: 'rgba(45,212,191,0.08)', orb2: 'rgba(99,102,241,0.06)' }
        : { orb1: 'rgba(99,102,241,0.08)', orb2: 'rgba(45,212,191,0.05)' };
